 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calculator.soap.metro.maxramos.ph/", wsdlLocation = "http://localhost:8080/metro-soap-calculator/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calculator.soap.metro.maxramos.ph/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/metro-soap-calculator/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calculator.soap.metro.maxramos.ph/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.soap.metro.maxramos.ph/", "CalculatorPort"), Calculator.class, features);
    }
